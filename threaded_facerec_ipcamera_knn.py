...
def Train_Recognize(thresh):
    repo_path = '/home/srec/Desktop/FaceRPI/gblock_device'
    ...
    while 1 > 0:
        ...
        if get_time()=="08:55" or get_time()=="20:40":
            print('time up')
            if get_time()=="08:55":
                break
            elif get_time()=="20:40":
                storage.child("/Attendance/"+get_date()+"_5.csv").put('/home/srec/Desktop/FaceRPI/data/'+get_date()+".csv")
            break
